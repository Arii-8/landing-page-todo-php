      ...
      <div class="row">
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
          ...
          <form action="" method="post" id="text-editor" enctype="multipart/form-data">
            ...
            <div class="form-group" style="margin-top: 20px;">
                <button type="submit" name="status" value="published" class="btn btn-primary" style="border-radius: 3px; color: white;">Tambah</button>
                ...
                <a href="../dashboard.php" class="btn btn-danger" style="border-radius: 3px; color: white;">Cancel</a>
            </div>
        </form>
