...
<html lang="en">
  ...
  <nav class="navbar navbar-dark bg-dark fixed-top">
        ...
        <div class="container-fluid" style="margin-top: 80px;">
          ...
          <hr class="line"/>
        <form action="auth/LoginProcess.php" method="post" enctype= multipart/form-data style="margin-top: 40px;">
        ...
        <div class="form-label-group" style="margin-top: 20px; margin-bottom: -25px;">
         <p style="font-family: arial; font-weight: bold; font-size: 0.8em;">Jika belum ada akun? ここに登録 (とうろく) <a href="register.php" style="color: #0D6EFD;">Register!</a> </p>
        </div>

        <div class="form-label-group">
          <button type="submit" class="btn btn-primary"  style="border-radius: 3px; color: white; margin-top: 20px;">Login</button>
        </div>
